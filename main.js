...
expressApp.use('/scripts/Handlers', express.static(__dirname + '/scripts/Handlers'));
expressApp.use('/scripts/Drawings', express.static(__dirname + '/scripts/Drawings'));
expressApp.use('/scripts/Utils', express.static(__dirname + '/scripts/Utils'));
expressApp.use('/images/Resources', express.static(__dirname + '/images/Resources'));
